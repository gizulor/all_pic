...
<ul>
  ...
  <li>Image thumbnails need to be available in your <code>image/</code> directory</li>
</ul>

<h2>Installation</h2>

<p>If using Textpattern 4.9+, upload the plugin zip folder using the installer in the <code>Plugins</code> tab.</p>
